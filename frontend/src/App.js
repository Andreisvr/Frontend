...
import ThesisInfo from './pages/main/ThesisInfoForm.js';
import Cabinet from './pages/main/MainPage.js';
import RegisterStud from './pages/Register_Form_Stud';
import ThesisProposalForm from './pages/main/add_thesis_form.js';
